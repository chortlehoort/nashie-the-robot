module.exports = function(robot) {
  ...
  robot.respond(/top/i, function(res) {
    ...
    help[help.length] = "award <slack handle> <points> -m <comments> - Awards students points towards top developer (e.g. `po award test.student 10 -m Strong leadership in group project`)";
